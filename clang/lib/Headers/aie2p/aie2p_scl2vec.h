...
#ifndef __AIE2P_SCL2VEC_H__
#define __AIE2P_SCL2VEC_H__
...
shiftx(v128int4 a, v128int4 b, int step, unsigned int shift) {
  return __builtin_aie2p_vshift_I512_I512(a, b, step, shift);
}
...
shiftx(v32bfloat16 a, v32bfloat16 b, int step, unsigned int shift) {
  return __builtin_aie2p_vshift_bf512_bf512(a, b, step, shift);
}
...
INTRINSIC(v16uint32) upd_elem(v16uint32 v, int idx, v2uint32 b) {
  ...
  INTRINSIC(v16cint16) upd_elem(v16cint16 v, int idx, v2cint16 b) {
    return vector_insert64((v16int32)v, idx, b);
  }
...
INTRINSIC(v32bfloat16) upd_elem(v32bfloat16 v, int idx, v4bfloat16 b) {
  return __builtin_aie2p_vinsert_bf64_bf512(v, idx, b);
}

INTRINSIC(v32bfloat16) upd_elem(v32bfloat16 v, int idx, unsigned long long b) {
  return __builtin_aie2p_vinsert_bf64_bf512(v, idx, (v4bfloat16)b);
}
...
INTRINSIC(v128uint4) insert(v128uint4 v, int idx, mask64 b) {
  return vector_insert64((v16uint32)v, idx, (v2uint32)b);
}
...
INTRINSIC(v16uint32) insert(v16uint32 v, int idx, mask64 b) {
  return vector_insert64((v16uint32)v, idx, (v2uint32)b);
}
#if 0
INTRINSIC(v16cint16) insert(v16cint16 v, int idx, unsigned long long b) {
  return vector_insert64((v16int32)v, idx,
                                        (v2uint32)b);
}
...
INTRINSIC(v16acc32) shuffle(v16acc32 a, v16acc32 b, unsigned int mode) {
  return __builtin_aie2p_vshuffle(a, b, mode);
}
...
#if 0
INTRINSIC(v8cint32)    shuffle(v8cint32 a,    v8cint32 b,    unsigned int mode) { return __builtin_aie2p_vshuffle(a, b, mode); }
INTRINSIC(v16cint16)   shuffle(v16cint16 a,   v16cint16 b,   unsigned int mode) { return __builtin_aie2p_vshuffle(a, b, mode); }
INTRINSIC(v16float)    shuffle(v16float a,    v16float b,    unsigned int mode) { return __builtin_aie2p_vshuffle(a, b, mode); }
#endif
...
shuffle(v32bfloat16 a, v32bfloat16 b, unsigned int mode) {
  return __builtin_aie2p_vshuffle(__builtin_bit_cast(v16int32, a),
...
INTRINSIC(v64int8) shuffle_s8(int b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle8(b, m);
}
INTRINSIC(v32int16) shuffle_s16(int b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle16(b, m);
}
INTRINSIC(v16int32) shuffle_s32(int b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle32(b, m);
}
INTRINSIC(v16int32) shuffle_v2s32(v2int32 b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle64(b, m);
}
...
#if 0
INTRINSIC(v16cint16)   shuffle_c16     (      cint16 b, unsigned int m) {  return __builtin_aie2p_vbcst_shuffle32(b,m) ;}
INTRINSIC(v16float)    shuffle_float   (float        b, unsigned int m) {  return __builtin_aie2p_vbcst_shuffle32(b,m) ;}
#endif
INTRINSIC(v16float) shuffle_float(float b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle32(__builtin_bit_cast(int, b), m);
}
INTRINSIC(v32bfloat16) shuffle_bfloat16(bfloat16 b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle16((int)__builtin_bit_cast(short, b), m);
}

INTRINSIC(v16int32) shuffle_s64(mask64 b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle64((v2int32)b, m);
}
INTRINSIC(v16uint32) shuffle_u64(mask64 b, unsigned int m) {
  return __builtin_aie2p_vbcst_shuffle64((v2uint32)b, m);
}
#if 0
INTRINSIC(v8cint32)  shuffle_c32 ( cint32 b, unsigned int m) { return __builtin_aie2p_vbcst_shuffle64((cint32_w64)b, m);}
#endif
...
ext_elem(v16int32 v, int idx, int sign) DIAGNOSE_EXT_IDX {
  return vector_extract((v16int32)v, idx, sign);
}
...
INTRINSIC(mask64)
ext_mask64(v128int4 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16int32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v64int8 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16int32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v32int16 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16int32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v16int32 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16int32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v128uint4 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16uint32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v64uint8 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16uint32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v32uint16 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (mask64)(vector_extract64((v16uint32)v, idx, sign));
}

INTRINSIC(mask64)
ext_mask64(v16uint32 v, int idx, int sign) DIAGNOSE_EXT_IDX {
...
ext_elem(v8cint32 v, int idx, int sign) DIAGNOSE_EXT_IDX {
   return (cint32)vector_extract64((v16uint32)v, idx, sign);
}
#endif
INTRINSIC(mask64)
ext_mask64(v32bfloat16 v, int idx, int sign) DIAGNOSE_EXT_IDX {
...
INTRINSIC(v2float)
extract_v2float(v16float v, int idx, int sign) DIAGNOSE_EXT_IDX {
...
INTRINSIC(v2float) extract_v2float(v16float v, int idx) DIAGNOSE_EXT_IDX {
  return extract_v2float(v, idx, __SIGN_SIGNED);
}

INTRINSIC(v16int4)
extract_mask64(v128int4 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16int32)v, idx, sign));
}

INTRINSIC(v8int8)
extract_mask64(v64int8 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16int32)v, idx, sign));
}

INTRINSIC(v4int16)
extract_mask64(v32int16 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16int32)v, idx, sign));
}

INTRINSIC(v2int32)
extract_mask64(v16int32 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16int32)v, idx, sign));
}

INTRINSIC(v16uint4)
extract_mask64(v128uint4 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16uint32)v, idx, sign));
}

INTRINSIC(v8uint8)
extract_mask64(v64uint8 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16uint32)v, idx, sign));
}

INTRINSIC(v4uint16)
extract_mask64(v32uint16 v, int idx, int sign) DIAGNOSE_EXT_IDX {

  return (ext_mask64((v16uint32)v, idx, sign));
}

INTRINSIC(v2uint32)
extract_mask64(v16uint32 v, int idx, int sign) DIAGNOSE_EXT_IDX {
...
INTRINSIC(void *) ext_address(v16int32 v, int idx) {
  return (void *)vector_extract((v16int32)v, idx, __SIGN_UNSIGNED);
}
...
INTRINSIC(v16int32)
broadcast_s64(mask64 b) { return vector_broadcast64((v2int32)b); }
...
INTRINSIC(v16uint32)
broadcast_u64(mask64 b) { return vector_broadcast64((v2uint32)b); }

INTRINSIC(v16uint32)
broadcast_v2u32(v2uint32 b) { return vector_broadcast64(b); }

INTRINSIC(v32bfloat16)
broadcast_bfloat16(bfloat16 b) { return b - v32bfloat16{0}; }
...
#if 0
INTRINSIC(v16cint16)
broadcast_c16 (cint16 b) { return b - v16uint32{0};}

INTRINSIC(v8cint32)
broadcast_c32 (cint32 b) { return vector_broadcast64(b);}
#endif
...
#if 0
INTRINSIC(v16cint16)
broadcast_to_v16cint16 (cint16 b) { return b - v16uint32{0}; }

INTRINSIC(v16cint16)
broadcast_to_v16cint16 (v2cint16 b) { return vector_broadcast64(b); }

INTRINSIC(v8cint32)
broadcast_to_v8cint32 (cint32 b) { return vector_broadcast64(b); }
#endif

INTRINSIC(v32bfloat16)
broadcast_to_v32bfloat16(bfloat16 b) { return broadcast_bfloat16(b); }

INTRINSIC(v32bfloat16)
broadcast_to_v32bfloat16(v2bfloat16 b) {
  return __builtin_aie2p_vbroadcast_bf32_bf512(b);
}

INTRINSIC(v32bfloat16)
broadcast_to_v32bfloat16(v4bfloat16 b) {
  return __builtin_aie2p_vbroadcast_bf64_bf512(b);
}
...
INTRINSIC(v16accfloat)
broadcast_to_v16accfloat(v2float b) {
...
INTRINSIC(v16float)
broadcast_to_v16float(v2float b) {
  mask64 as_mask64 = __builtin_bit_cast(mask64, b);
  return broadcast_s64(as_mask64);
}
...
INTRINSIC(v64int8)
broadcast_elem(v64int8 v, int idx) { return broadcast_s8(ext_elem(v, idx, 0)); }
...
INTRINSIC(v16int32)
broadcast_elem_128(v16int32 v, int idx) {
  return __builtin_aie2p_vextract_broadcast128_I512(v, idx);
}
...
broadcast_elem(v32bfloat16 v, int idx) {
  return __builtin_aie2p_vextract_broadcast_bf32_bf512(v, idx);
}

#if 0
INTRINSIC(v16cint16)
broadcast_elem (v16cint16 v, int idx) {
  return __builtin_aie2p_vextract_broadcast32_I512(v, idx);
}
...
INTRINSIC(v32accfloat) broadcast_zero_to_v32accfloat() {
  return __builtin_bit_cast(v32accfloat, (float)0 - v32float{0});
}

INTRINSIC(v64accfloat) broadcast_zero_to_v64accfloat() {
