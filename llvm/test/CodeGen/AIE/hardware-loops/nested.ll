...
; AIE2-NEXT:    nopb ; lda r5, [p3], #4; nops ; nopxm ; nopv
; AIE2-NEXT:    nopx
; AIE2-NEXT:    nop
...
; AIE2-NEXT:    add r2, r2, r5 // Delay Slot 2
...
; AIE2P-NEXT:    lda r5, [p3], #4; nopb ; nops ; nopxm ; nopv
; AIE2P-NEXT:    nopx
; AIE2P-NEXT:    nop
...
; AIE2P-NEXT:    add r2, r2, r5 // Delay Slot 2
